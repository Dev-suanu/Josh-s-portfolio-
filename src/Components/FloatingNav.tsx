...
const navLinks = [
  ...
  { name: "WorkWave", target: "workwave", icon: <Globe size={18} /> }, // Represents energy/founding
  { name: "Skills", target: "skills", icon: <Award size={18} /> }, // Represents competencies
  { name: "History", target: "contributions", icon: <History size={18} /> }, // Represents the log/timeline
  { name: "Contact", target: "contact", icon: <Phone size={18} /> }, // Represents the X DM/Signal
];
